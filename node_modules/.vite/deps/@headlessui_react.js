...
var fe3 = H(function(o9, t10) {
  let _a = o9, { value: r8, name: m12, onChange: f11, disabled: R5 = false } = _a, I4 = __objRest(_a, ["value", "name", "onChange", "disabled"]), [{ options: a3 }, A4] = (0, import_react31.useReducer)(ue3, { options: [] }), [T7, C9] = B4(), [k6, c8] = M3(), y4 = `headlessui-radiogroup-${I()}`, g6 = (0, import_react31.useRef)(null), b9 = T(g6, t10), E5 = (0, import_react31.useMemo)(() => a3.find((e4) => !e4.propsRef.current.disabled), [a3]), D6 = (0, import_react31.useMemo)(() => a3.some((e4) => e4.propsRef.current.value === r8), [a3, r8]), s9 = (0, import_react31.useCallback)((e4) => {
    var i9;
    if (R5 || e4 === r8)
      return false;
...
var V5 = H(function(n2, i9) {
  let _a = n2, { checked: e4, onChange: a3, name: o9, value: d7 } = _a, u7 = __objRest(_a, ["checked", "onChange", "name", "value"]), p12 = `headlessui-switch-${I()}`, t10 = (0, import_react32.useContext)(m11), h6 = (0, import_react32.useRef)(null), S2 = T(h6, i9, t10 === null ? null : t10.setSwitch), s9 = (0, import_react32.useCallback)(() => a3(!e4), [a3, e4]), w6 = (0, import_react32.useCallback)((r8) => {
...
var ee3 = { [0](e4, t10) {
  return e4.selectedIndex === t10.index ? e4 : __spreadProps(__spreadValues({}, e4), { selectedIndex: t10.index });
}, [1](e4, t10) {
  ...
  return e4.tabs.includes(t10.tab) ? e4 : __spreadProps(__spreadValues({}, e4), { tabs: [...e4.tabs, t10.tab] });
}, [4](e4, t10) {
  return __spreadProps(__spreadValues({}, e4), { tabs: e4.tabs.filter((i9) => i9 !== t10.tab) });
}, [5](e4, t10) {
  return e4.panels.includes(t10.panel) ? e4 : __spreadProps(__spreadValues({}, e4), { panels: [...e4.panels, t10.panel] });
}, [6](e4, t10) {
  return __spreadProps(__spreadValues({}, e4), { panels: e4.panels.filter((i9) => i9 !== t10.panel) });
}, [7](e4) {
...
var re3 = H(function(t10, i9) {
  let _a = t10, { defaultIndex: u7 = 0, vertical: x7 = false, manual: d7 = false, onChange: f11, selectedIndex: l9 = null } = _a, r8 = __objRest(_a, ["defaultIndex", "vertical", "manual", "onChange", "selectedIndex"]);
...
var $3 = H(function(r8, t10) {
  let _a = r8, { beforeEnter: n2, afterEnter: u7, beforeLeave: m12, afterLeave: s9, enter: o9, enterFrom: i9, enterTo: d7, entered: S2, leave: x7, leaveFrom: E5, leaveTo: L8 } = _a, p12 = __objRest(_a, ["beforeEnter", "afterEnter", "beforeLeave", "afterLeave", "enter", "enterFrom", "enterTo", "entered", "leave", "leaveFrom", "leaveTo"]), h6 = (0, import_react35.useRef)(null), y4 = T(h6, t10), [f11, A4] = (0, import_react35.useState)("visible"), D6 = p12.unmount ? x.Unmount : x.Hidden, { show: g6, appear: ee4, initial: te3 } = ge3(), { register: P3, unregister: H5 } = ve4(), O10 = (0, import_react35.useRef)(null), a3 = I(), re4 = (0, import_react35.useRef)(false), k6 = X5(() => {
...
var j7 = H(function(r8, t10) {
  ...
  let y4 = { unmount: m12 };
  return import_react35.default.createElement(R4.Provider, { value: x7 }, import_react35.default.createElement(N7.Provider, { value: h6 }, A({ ourProps: __spreadProps(__spreadValues({}, y4), { as: import_react35.Fragment, children: import_react35.default.createElement($3, __spreadValues(__spreadValues({ ref: o9 }, y4), s9)) }), theirProps: {}, defaultTag: import_react35.Fragment, features: Z4, visible: d7 === "visible", name: "Transition" })));
});
function Ee4(e4) {
  let r8 = (0, import_react35.useContext)(N7) !== null, t10 = s5() !== null;
  return import_react35.default.createElement(import_react35.default.Fragment, null, !r8 && t10 ? import_react35.default.createElement(j7, __spreadValues({}, e4)) : import_react35.default.createElement($3, __spreadValues({}, e4)));
}
